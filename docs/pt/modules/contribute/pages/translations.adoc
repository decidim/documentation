...
Se você estiver curioso, no nível técnico temos um bot (o grande robô-decidim) que periodicamente faz um PR para as branches relevantes (últimos lançamentos e desenvolvimentos).
