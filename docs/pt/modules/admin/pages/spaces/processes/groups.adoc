...
|Título
|Obrigatório
|Título do grupo de processos participativos.
...
|Promovido
|Opcional
|Verifique se você quiser que o processo tenha mais visibilidade na lista pública de Processos. It'll also be visible in the "Highlighted processes"
