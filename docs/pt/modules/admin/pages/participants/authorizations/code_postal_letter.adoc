...
Isso deve-se ao facto de a carta poder estar a ser enviada. If this needs to be corrected, then the participant needs
...
as such with the icon image:icons/action_verify.png[Mark as sent]. Também mostrará quando a carta foi enviada.
