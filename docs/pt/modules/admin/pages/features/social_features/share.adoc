...
Os links de compartilhamento permitem um compartilhamento mais fácil para diferentes serviços de mídia social que podem ser configurados para Decidim por meio dos arquivos de configuração.
