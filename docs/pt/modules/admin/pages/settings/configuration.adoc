...
|Sócio
|Obrigatório
|Manipuladores sociais para diferentes redes sociais. In the field, only add the necessary slug instead of the whole URL.
...
|Time Zone
|Obrigatório
|Em que fuso horário é sua organização.
