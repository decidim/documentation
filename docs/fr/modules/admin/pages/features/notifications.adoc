...
|Administration |A new attachment has been created |✅ |❌ |❌
...
|Suivi des réalisations |The proposal has been included in a result |✅ |❌ |❌
...
|Propositions |A new proposal has been published |✅ |❌ |❌
