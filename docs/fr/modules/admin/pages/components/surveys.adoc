...
La fonctionnalité Enquête permet aux participants de répondre à des questionnaires. Ceci est utile lorsqu'une organisation souhaite recevoir des retours privés
de la part des participants. Il permet de définir un ensemble de questions avec plusieurs types de réponses.

NOTE: Une fois l'enquête complétée par participants, il n'est pas possible de modifier ses questions, car cela affecterait l'intégrité
...
|Mandatory
|Facultatif
|À cocher dans le cas où les participants doivent répondre à cette question pour compléter l'enquête.
...
avec un nombre maximum de choix. Il est possible de définir une option "Texte libre" pour que les participants soumettent leur propre réponse.
...
Cette fonctionnalité permet aux administrateurs de créer des enquêtes complexes, c'est-à-dire que certaines questions s'affichent seulement si les participants ont sélectionné certaines réponses spécifiques aux questions précédentes.
...
|Option de réponse
|Obligatoire
|Ce champ propose les options de réponse aux questions qui doivent être choisies par les participants pour remplir la condition.
...
L'exportation n'inclue pas les données des utilisateurs. Pour les collecter, assurez-vous de créer des questions d'enquête spécifiques à ces données.

NOTE: La plateforme ne gère pas le traitement des réponses ni la présentation des résultats ou le résumé aux utilisateurs. Il est nécessaire de le faire en dehors de l'exportation.
