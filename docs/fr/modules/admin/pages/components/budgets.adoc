...
Les administrateurs peuvent décider des règles de vote, pour que les participants sélectionnent un nombre défini de projets, ou votez pour comme
plusieurs projets qu'ils veulent jusqu'à atteindre un certain montant.

image::components/budgets/example01.png[Budgets example voting]

Les administrateurs ont plusieurs options pour le flux de vote et pour les règles de vote.
...
Pour créer un composant Budget, allez d'abord dans xref:admin:spaces.adoc[espace participatif] où vous voulez le créer.
...
.Formulaire de budgets - Paramètres globaux
|===
|Champ |Type |Description
...
|Projets par page
|Obligatoire
|Combien de projets sont affichés par page sur la page d'accueil du budget.
...
|Facultatif
|Si vous voulez que les participants soient en mesure de commenter les projets.
...
|Vote
|Obligatoire
|Choisissez l'une des options suivantes selon la phase du processus : Vote désactivé, Vote activé ou Vote terminé.

|Afficher les votes
|Facultatif
|Que le nombre de votes soit public. Nous vous recommandons fortement de ne cocher cette option qu'une fois le vote terminé.
...
|Page d'accueil des budgets
|Facultatif
|Le message affiché sur la page d'accueil des budgets quand il y a plusieurs budgets pour cette phase.
...
. Sur les projets qui ont été sélectionnés, allez dans chaque projet, éditez-le et cochez la case "Sélectionné pour l'implémentation".
