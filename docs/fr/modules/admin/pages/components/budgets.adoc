...
La fonctionnalité Budget permet aux participant·e·x·s de voter en sélectionnant les projets de leur choix. Cette fonctionnalité a été conçue pour
...
Les administrateur·ices peuvent décider des règles de vote, pour que les participant·e·x·s sélectionnent un nombre défini de projets, ou votent pour autant de
 projets qu'iels le souhaitent jusqu'à atteindre un certain montant.

image::components/budgets/example01.png[Budgets example voting]

Les administrateur·ices ont plusieurs options pour le workflow de vote et pour les règles de vote.
...
Pour créer une fonctionnalité Budget, aller d'abord dans xref:admin:spaces.adoc[espace participatif] à l'endroit de création souhaité.
...
|Processus
|Obligatoire
|Comment les participant·e·x·s peuvent voter s'il y a plusieurs ensembles de budget. Vous pouvez définir votre propre workflow ou en utiliser un déjà disponible.
...
|Permet de définir un "Pourcentage de seuil de vote" signifiant un pourcentage du budget total que les participant·e·x·s
doivent atteindre pour pouvoir terminer le vote.

|Activer la règle : Nombre minimum de projets à voter
|Optionnel, mais incompatible avec les 2 autres règles de vote.
|Permet de définir un "nombre minimum de projets à voter" signifiant un nombre de projets que les participant·e·x·s
doivent atteindre pour pouvoir terminer le vote.
...
le nombre de projets que les participant·e·x·s doivent voter comme un minimum et maximum pour pouvoir terminer le vote.

|Commentaires activés
|Facultatif
|Les participant·e·x·s peuvent ainsi commenter les projets.
...
Une fois le vote terminé, unx administrateur·ice doit :
...
. Sur les projets qui ont été sélectionnés, aller dans chaque projet, l'éditer et cocher la case "Sélectionné pour la mise en oeuvre".

image::components/budgets/results_select_project.png[Select a project for implementation]

Ensuite, la liste des projets montre tous les projets qui ont été sélectionnés pour leur mise en oeuvre.

image::components/budgets/results_selected.png[Selected projects after voting]

Un filtre est également affiché pour les participant·e·x·s afin de voir quels projets ont été sélectionnés, et trouver ceux qui n'ont pas été sélectionnés.

image::components/budgets/results_selected_frontend.png[Selected projects after voting in the frontend]

TIP: Une fois que vous avez sélectionné des projets, vous pouvez activer la fonctionnalité xref:components/Accounability.adoc[Accountability]
pour que les participants puissent voir l'état d'avancement de la mise en oeuvre des projets.
