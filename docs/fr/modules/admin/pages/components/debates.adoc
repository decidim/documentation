...
La fonctionnalité Débat permet aux personnes d'avoir des discussions, sans votes ni priorités. Il permet également de clore les débats,
en ajoutant des conclusions ou un résumé des sujets de la discussion.
...
Pour créer une fonctionnalité Débat, aller d'abord dans xref:admin:spaces.adoc[espace participatif] à l'endroit de création souhaité.
...
.Formulaire de débat - Paramètres généraux
[cols="20h,10h,~"]
|===
|Champ |Type |Description
...
|Soutiens activés
|Facultatif
|Cocher cette case pour permettre aux participants de montrer un soutien public pour les débats.
...
|Facultatif
|Cocher cette case pour permettre la création de nouveaux débats par les participants durant cette étape.
...
|Obligatoire
|Choisissez entre Finite et Ouvrir. Limité signifie que le débat a une date et une heure de début et de fin, Ouvert signifie que
...
|Commentaires activés
|Facultatif
|Pour activer les commentaires. Les participants peuvent ainsi commenter le débat.
|===
...
Prendre en compte que si le débat a été créé par un participant, alors seul ce participant peut le fermer.
