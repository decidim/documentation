...
.Ajouter une fonctionnalité : Formulaire de débat
[cols="20h,10h,~"]
|===
...
.Ajouter une fonctionnalité : Formulaire de débats - Paramètres de l'étape
[cols="20h,10h,~"]
|===
|Champ |Type |Description
...
Pour commencer à créer et à gérer des débats, cliquez dans le titre de la fonctionnalité dans la barre de navigation ou dans la liste des fonctionnalités, ou cliquez sur image:icons/action_edit.png[Icône gérer la fonctionnalité].
...
NOTE: Lorsque les participant·e·x·s peuvent créer des débats, les administrateur·ices ont moins d'actions disponibles, et ne peuvent pas modifier ou supprimer les débats.
