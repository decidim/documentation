...
|Obligatoire
|Choisissez entre Finite et Ouvrir. Finite means that the debate has a starting and ending date and time, Open means that
...
Un débat peut être clos. This is useful for publishing debates conclusions.
