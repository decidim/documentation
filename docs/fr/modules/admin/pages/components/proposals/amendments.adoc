...
. Alice reçoit une notification que Bob a proposé un amendement à sa proposition originale
image:components/propositions/amendements/proposal_amendemed_notification.png[]
...
|Amendements activés
|Global
|Cochez cette case pour activer xref:components/propositions/amendements.adoc[amendments] dans les propositions. Autres paramètres visibles en activant un.
