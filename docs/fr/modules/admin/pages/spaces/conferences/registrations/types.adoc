...
|Rang d'affichage
|Obligatoire
|Which order it has in relation to the other types. Avoir un nombre inférieur signifie un rang d'affichage plus élevé. For instance, if you have two types, "Day 1" with weight "10" and "Day 2" with weight "0" then "Day 2" is first when ordering.
...
|Prix
|Facultatif
|Définissez un prix pour ce type d'inscription. If you don't define a price, then it's free.
