...
C'est parce que la lettre pourrait être en cours d'envoi. If this needs to be corrected, then the participant needs
...
as such with the icon image:icons/action_verify.png[Mark as sent]. Il sera également affiché quand la lettre a été envoyée.
