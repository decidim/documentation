...
Ici vous pouvez trouver tous les articles de blog pour chaque version mineure.

Vous pouvez trouver toutes les versions (avec des patchs mineurs et mineurs) sur
https://rubygems.org/gems/decidim/versions[RubyGems.org] et
