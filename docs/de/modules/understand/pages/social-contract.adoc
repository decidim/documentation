...
Wenn Sie es in Ihre eigene Sprache übersetzen möchten, bitte https://decidim.org/contact[kontaktieren Sie uns].
====
...
Es wird eine Verpflichtung gegenüber den Bürgern eingeleitet, alle Fragen und Beiträge in kürzester Zeit zu beantworten. Es wird auch eine Verpflichtung übernommen, die Ergebnisse der partizipatorischen Prozesse zu verfolgen und auf die Forderungen zu reagieren, die speziell darum ersuchen. Schliesslich soll die Verpflichtung eingegangen werden, die Einbeziehung von Indikatoren zur Überwachung der Beteiligungsprozesse nach deren Abschluss zu prüfen, um ihre Umsetzung systematisch zu bewerten.

== Kontinuierliche Verbesserung und interinstitutionelle Zusammenarbeit

Es werden Mechanismen für die regelmässige Überprüfung und Evaluierung zur Verfügung gestellt, um die kontinuierliche Verbesserung der Plattform zu erleichtern.

Der Zusammenarbeit und dem Erfahrungsaustausch zwischen den am Projekt beteiligten Institutionen wird Priorität eingeräumt, mit dem Ziel, die Plattform zu verbessern, zu korrigieren und neue Entwicklungen für ihre kontinuierliche Verbesserung zu schaffen.

In diesem Sinne werden Bedingungen und Umgebungen für die Zusammenarbeit erleichtert, wenn Verbesserungen vorangebracht werden, die auf einen gemeinsamen Nutzen für die gesamte Plattform abzielen, wobei bei Bedarf Koordinationsmechanismen zwischen den Institutionen aktiviert werden.