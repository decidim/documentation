...
Ein partizipatorischer Prozess ist eine Abfolge von Phasen, die rechtzeitig bestellt werden. Depending on which phase of the process timeline you
...
|Startdatum
|Optional
|The start date of this process phase. Erwartetes Format: dd/mm/yyy

|Enddatum
|Optional
|The end date of this process phase. Erwartetes Format: dd/mm/yyy
