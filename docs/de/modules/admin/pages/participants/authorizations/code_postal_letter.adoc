...
Das liegt daran, dass der Brief im Prozess der Versendung sein könnte. If this needs to be corrected, then the participant needs
...
as such with the icon image:icons/action_verify.png[Mark as sent]. Es wird auch angezeigt, wann der Brief gesendet wurde.
