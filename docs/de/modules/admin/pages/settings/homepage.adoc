...
Can be customized in xref:admin:settings/appearance.adoc#edit_homepage_appearance[Appearance] thanks to the Call To Action button fields.
...
In the screenshot below, the CTA button has been personalized in the  in xref:admin:settings/appearance.adoc#_edit_homepage_appearance[Appearance] section.
...
configured in xref:admin:settings/appearance.adoc#_edit_homepage_appearance[Appearance].
