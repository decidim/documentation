...
Wenn du neugierig bist, in der technischen Ebene haben wir einen Bot (der große Dezimalbot), der periodisch eine PR an die relevanten Zweige (letzte Releases und Entwicklung) macht.
