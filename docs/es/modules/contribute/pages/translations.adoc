...
Si eres curios, en el nivel técnico tenemos un bot (el gran decidim-bot) que periódicamente hace un PR a las ramas relevantes (últimas versiones y desarrollo).
