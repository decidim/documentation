...
Esto se debe a que la carta podría ser enviada. If this needs to be corrected, then the participant needs
...
as such with the icon image:icons/action_verify.png[Mark as sent]. También se mostrará cuando la carta fue enviada.
