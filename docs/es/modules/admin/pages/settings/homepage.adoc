...
NOTE: En tu instalación puedes tener otros bloques de contenido, ya que esto depende de los módulos que tienes activos.
Póngase en contacto con el administrador del sistema si ve algo diferente aquí, como un bloque de contenido que falta.
