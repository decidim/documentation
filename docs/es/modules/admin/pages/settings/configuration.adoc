...
|Social
|Requerido
|Manejadores sociales para diferentes redes sociales. In the field, only add the necessary slug instead of the whole URL.
...
|Time Zone
|Requerido
|En qué zona horaria es su organización.
