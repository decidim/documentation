...
En algunos casos es necesario organizar procesos participativos por más de xref:spaces/processes/groups.adoc[Grupos de procesos].
...
|Título
|Requerido
|Título del tipo de proceso participativo.
|===
