...
La siguiente sección contiene una lista de participantes y grupos que el participante está siguiendo actualmente.
...
La sección de grupos contiene todos los grupos a los que pertenece el usuario.
