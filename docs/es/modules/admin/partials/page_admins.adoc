...
|Rol
|Requerido
|Which role does this administrator should have in the space. Puede ser cualquier Administrador, Colaborador, Moderador o Valorador.
|===
...
Un administrador de espacio puede administrar el espacio y cambiar la configuración del espacio. They can also invite new space administrators.
...
Un moderador de espacio puede revisar los contenidos reportados del espacio y ocultarlos o ocultarlos. They can also
