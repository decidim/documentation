...
|                                          | A user asked her data export                                                          | ❌     | ✅          | ❌
|                                          | A user I follow endorsed an ressource                                                 | ✅     | ❌          | ❌
...
|                                          | A user request has been rejected to join the user group                               | ❌     | ✅          | ❌
...
|                                          | The registration to the conference are open                                           | ✅     | ❌          | ❌
...
|                                          | You got added as a trustee for the election                                           | ❌     | ✅          | ❌
...
|                                          | A user sent her initiative to technical validation                                    | ❌     | ❌          | ✅
...
| Comments                                 | A ressource has been commented                                                        | ✅     | ❌          | ❌
|                                          | A user group has left a comment on a ressource                                        | ✅     | ❌          | ❌
|                                          | A user has left a comment on a ressource                                              | ✅     | ❌          | ❌
