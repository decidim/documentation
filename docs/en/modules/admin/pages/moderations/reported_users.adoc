...
Reported participants will be visible on the "Reported participants" section of the Global moderations panel. 
...
* *Reason*: why they have been reported. If the participant that made the report has given extra.
information it's possible to see it by hovering it.
* *Reported at*: when they were originally reported.
* *Reports count*: Number of times it has been reported by different users.
...
|Available when the participant is not yet blocked.
...
|Available when the participant is blocked.
