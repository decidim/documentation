...
and choose which investment projects the city government should implement.
...
. On the projects that according to the normative have been selected, they'll need to go to each project, edit it and
