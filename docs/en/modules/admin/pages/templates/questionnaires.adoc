...
image::templates/templates_backend_form.png[Backend: new template form]
...
image::templates/templates_backend_survey_form.png[Backend: new survey template form]
...
image::templates/templates_backend_survey_preview.png[Backend: new survey template preview]
