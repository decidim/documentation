...
image:moderations/moderations_participants_block_user_justification.png[Justificate the blocked user action]
...
See more at xref:admin:moderations/reported_users.adoc[Reported users]
