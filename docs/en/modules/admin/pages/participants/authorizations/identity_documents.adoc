...
* Offline: the participant will be asked to fill in some data, and then they will need to go to a presential place to show her documents face to face.
...
a participant can see the form for uploading a copy of her document. They also need to fill in their document type and number.
