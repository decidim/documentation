...
A group of processes can be useful for dividing large participatory processes into sub-processes according to a predefined criteria.
It can also allow administrators to organize an instance with a lot of processes, to gather together those related to a 
...
There, you will find the list of process groups.
...
|Edit
|Edit the configuration and components for the process group.
...
|Delete
|Delete this process group.

|===

== Create a process group

To create a new process group, click the "New process group" button on the top right of the page. 

=== About this process

This section allows you to provide a general description of the process group; mainly a title, image, and description, as well as
...
This section allows you to provide meta information about the process group.
...
|Who participates
|Optional
|The authorized participants who can participate to the process. 
...
Process groups are essentially landing pages, grouping more complex participatory processes. 
This landing page works with different content blocks, just like the general  xref:admin:settings/homepage.adoc[homepage] of the platform. 
...
You can configure how the results are sorted by most recent or random by clicking  the "Edit" icon on the landing page content block.
If there are no upcoming meetings, this block shows past meetings. 
...
You can configure it by clicking the "Edit" icon on the landing page content block (Note: only active processes will be displayed).

image::spaces/processes/processes_group_landing_processes.png[Participatory process group landing page processes block]

=== HTML blocks

The HTML block content block allows you to add an editable HTML block on the landing page, and therefore to create a customized section.
...
The https://participer.loire-atlantique.fr/processes_groups/32[Loire-Atlantique participatory budget], with a customized HTML block
on the landing page. 
