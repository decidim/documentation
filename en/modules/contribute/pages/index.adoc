...
You can read in detail about this process in xref:ROOT:governance.adoc[Governance]
...
* You can do so in https://translate.decidim.org[Decidim Translations]. See more in xref:contribute:translations[Translations].

== Do you want to add a new language to Decidim?

* https://decidim.org/contact[Contact] with us. See more in xref:contribute:translations[Translations].
