// The included files provide translations for all built-in attributes in Asciidoctor that emit translatable strings.
...
ifdef::page-lang[include::partial$attributes-{page-lang}.adoc[]]
//
// Translation for publication list titles ("Academic", "Media", etc.)
ifdef::page-lang[include::partial$publication-page-titles-{page-lang}.adoc[]]
