...
and choose which investment projects the city goverment should execute.
...
We strongly recommend that after you have selected projects then you enable the xref:admin:component_accountability.adoc[Accountability]
