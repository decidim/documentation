...
In your installation you could have other content blocks, as this depends on which modules you have active. Please put you in touch of your system admininstrator if you see something different here, like a missing content block.
...
NOTE: These area legacy settings that will be removed in a next version. https://github.com/decidim/decidim/pull/6284[See PR]. In this next version you're going to be able to change the button and path for this button from this same content block. 
